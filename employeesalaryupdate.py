...
def showemployeesalaryupdate():
    ...
    bt1=Button(d,text='Find',font=('biome',15),bg='light pink',command=finddata)
    ...
    bt2=Button(t,text='Update',font=('biome',15),bg='light pink',command=updatedata)
    bt2.place(x=200,y=300)
    
    t.mainloop()
    
#showemployeesalaryupdate()